...
#define DATA_PATH "data/cellculture/"

CCTestingWidget::CCTestingWidget(QWidget *parent) :
    QFrame(parent),
    ui(new Ui::CCTestingWidget) {
    ui->setupUi(this);
...
CCTestingWidget::~CCTestingWidget() {
    delete ui;
}

/**
 * @brief CCTestingWidget::setPlotTitle
 * @param title
 */
void CCTestingWidget::setPlotTitle(QString title) {
    m_pPlot->setPlotTitle(m_plotTitle + "(" + title + ")");
}

/**
 * @brief CCTestingWidget::setOperatingKeyEnable
 * @param ok
 */
void CCTestingWidget::setOperatingKeyEnable(bool ok) {
    if (m_pDyMsgBox != NULL) {
        m_pDyMsgBox->close();
        delete m_pDyMsgBox;
        m_pDyMsgBox = NULL;
...
/**
 * @brief CCTestingWidget::setAnimationEnable
 * @param ok
 */
void CCTestingWidget::setAnimationEnable(bool ok) {
    m_pFileExplorer->setAnimationEnable(ok);
    m_pRecordTableWidget->setAnimationEnable(ok);
}

/**
 * @brief CCTestingWidget::showEvent
 * @param event
 */
void CCTestingWidget::showEvent(QShowEvent *event) {
    Q_UNUSED(event)
    if (!m_isShow) {
        m_isShow = true;
...
/**
 * @brief CCTestingWidget::mousePressEvent
 * @param event
 */
void CCTestingWidget::mousePressEvent(QMouseEvent *event) {
    m_isPressed = true;
    m_pressPos = event->pos();
}

/**
 * @brief CCTestingWidget::mouseReleaseEvent
 * @param event
 */
void CCTestingWidget::mouseReleaseEvent(QMouseEvent *event) {
    m_isPressed = false;
...
/**
 * @brief CCTestingWidget::drawStaticCurve
 * @param curveName
 * @param x
 * @param y
 */
void CCTestingWidget::drawStaticCurve(QString title, QVector<double> x, QVector<double> y) {
    m_pPlot->drawStaticCurve(title, x, y);
}

/**
 * @brief CCTestingWidget::saveResult
 * @param fileName
 * @param data
 */
void CCTestingWidget::saveResult(QString fileName, QStringList data) {
...
/**
 * @brief CCTestingWidget::saveRecord
 * @param data
 */
void CCTestingWidget::saveRecord(QStringList data) {
    m_pRecordTableWidget->insert(data);
}

/**
 * @brief CCTestingWidget::capture
 */
void CCTestingWidget::capture() {
...
/**
 * @brief CCTestingWidget::showData
 * @param fileName
 */
void CCTestingWidget::showData(QString fileName) {
...
/**
 * @brief CCTestingWidget::doubleClickPlot
 */
void CCTestingWidget::doubleClickPlot() {
...
/**
 * @brief CCTestingWidget::doubleClickRecordTableWidget
 */
void CCTestingWidget::doubleClickRecordTableWidget() {
...
/**
 * @brief CCTestingWidget::onBlankBtnClicked
 */
void CCTestingWidget::onBlankBtnClicked() {
    ui->frameHeader->setEnabled(false);
    m_pPlot->clearCurves();
...
/**
 * @brief CCTestingWidget::onMeasureBtnClicked
 */
void CCTestingWidget::onMeasureBtnClicked() {
    ui->frameHeader->setEnabled(false);
    m_pPlot->clearCurves();
...
/**
 * @brief CCTestingWidget::initalizeSignals
 */
void CCTestingWidget::initalizeSignals() {
...
/**
 * @brief CCTestingWidget::initalizeWidgets
 */
void CCTestingWidget::initalizeWidgets() {
    ...
    m_pRecordTableWidget->setHorizontalHeaderStretchLastSection(true);
