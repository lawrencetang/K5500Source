...
#define DATA_PATH "data/nanogold/"

NGTestingWidget::NGTestingWidget(QWidget *parent) :
    QFrame(parent),
    ui(new Ui::NGTestingWidget) {
    ui->setupUi(this);
...
NGTestingWidget::~NGTestingWidget() {
    delete ui;
}

/**
 * @brief NGTestingWidget::setPlotTitle
 * @param title
 */
void NGTestingWidget::setPlotTitle(QString title) {
    m_pPlot->setPlotTitle(m_plotTitle + "(" + title + ")");
}

/**
 * @brief NGTestingWidget::setOperatingKeyEnable
 * @param ok
 */
void NGTestingWidget::setOperatingKeyEnable(bool ok) {
    if (m_pDyMsgBox != NULL) {
        m_pDyMsgBox->close();
        delete m_pDyMsgBox;
        m_pDyMsgBox = NULL;
...
/**
 * @brief NGTestingWidget::setAnimationEnable
 * @param ok
 */
void NGTestingWidget::setAnimationEnable(bool ok) {
    m_pFileExplorer->setAnimationEnable(ok);
    m_pRecordTableWidget->setAnimationEnable(ok);
}

/**
 * @brief NGTestingWidget::showEvent
 * @param event
 */
void NGTestingWidget::showEvent(QShowEvent *event) {
    Q_UNUSED(event)
    if (!m_isShow) {
        m_isShow = true;
...
/**
 * @brief NGTestingWidget::mousePressEvent
 * @param event
 */
void NGTestingWidget::mousePressEvent(QMouseEvent *event) {
    m_isPressed = true;
    m_pressPos = event->pos();
}

/**
 * @brief NGTestingWidget::mouseReleaseEvent
 * @param event
 */
void NGTestingWidget::mouseReleaseEvent(QMouseEvent *event) {
    m_isPressed = false;
...
/**
 * @brief NGTestingWidget::drawStaticCurve
 * @param curveName
 * @param x
 * @param y
 */
void NGTestingWidget::drawStaticCurve(QString title, QVector<double> x, QVector<double> y) {
    m_pPlot->drawStaticCurve(title, x, y);
}

/**
 * @brief NGTestingWidget::saveResult
 * @param fileName
 * @param data
 */
void NGTestingWidget::saveResult(QString fileName, QStringList data) {
...
/**
 * @brief NGTestingWidget::saveRecord
 * @param data
 */
void NGTestingWidget::saveRecord(QStringList data) {
    m_pRecordTableWidget->insert(data);
}

/**
 * @brief NGTestingWidget::capture
 */
void NGTestingWidget::capture() {
...
/**
 * @brief NGTestingWidget::showData
 * @param fileName
 */
void NGTestingWidget::showData(QString fileName) {
...
/**
 * @brief NGTestingWidget::doubleClickPlot
 */
void NGTestingWidget::doubleClickPlot() {
...
/**
 * @brief NGTestingWidget::doubleClickRecordTableWidget
 */
void NGTestingWidget::doubleClickRecordTableWidget() {
...
/**
 * @brief NGTestingWidget::onBlankBtnClicked
 */
void NGTestingWidget::onBlankBtnClicked() {
    ui->frameHeader->setEnabled(false);
    m_pPlot->clearCurves();
...
/**
 * @brief NGTestingWidget::onMeasureBtnClicked
 */
void NGTestingWidget::onMeasureBtnClicked() {
    ui->frameHeader->setEnabled(false);
    m_pPlot->clearCurves();
...
/**
 * @brief NGTestingWidget::initalizeSignals
 */
void NGTestingWidget::initalizeSignals() {
...
/**
 * @brief NGTestingWidget::initalizeWidgets
 */
void NGTestingWidget::initalizeWidgets() {
