...
#include "ui_ngparameterwidget.h"
...
NGParameterWidget::NGParameterWidget(QWidget *parent) :
    QFrame(parent),
    ui(new Ui::NGParameterWidget) {
    ui->setupUi(this);
...
NGParameterWidget::~NGParameterWidget() {
    delete ui;
}

/**
 * @brief NGParameterWidget::getMeasureSetting
 * @return
 */
QStringList NGParameterWidget::getMeasureSetting() {
...
/**
 * @brief NGParameterWidget::setMeasureSetting
 * @param data
 */
void NGParameterWidget::setMeasureSetting(QStringList data) {
...
/**
 * @brief NGParameterWidget::getMotorSetting
 * @return
 */
QStringList NGParameterWidget::getMotorSetting() {
...
/**
 * @brief NGParameterWidget::setMotorSetting
 * @param data
 */
void NGParameterWidget::setMotorSetting(QStringList data) {
    for (int i = 0; i < data.size(); i ++) {
        QString s = data.at(i);
...
/**
 * @brief NGParameterWidget::getCurrentMethod
 */
QString NGParameterWidget::getCurrentMethod() {
    return ui->comboBoxMethod->currentText();
}

/**
 * @brief NGParameterWidget::restore
 */
void NGParameterWidget::restore() {
...
/**
 * @brief NGParameterWidget::changeCofficient
 * @param index
 */
void NGParameterWidget::changeParameter(int index) {
...
/**
 * @brief NGParameterWidget::changeDetectionMothed
 * @param method
 */
void NGParameterWidget::changeDetectionMothed(QString method) {
...
/**
 * @brief NGParameterWidget::initializeSignals
 */
void NGParameterWidget::initializeSignals() {
...
/**
 * @brief NGParameterWidget::initializeWidgets
 */
void NGParameterWidget::initializeWidgets() {
