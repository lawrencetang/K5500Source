/********************************************************************************
** Form generated from reading UI file 'nasettingwidget.ui'
**
...
#ifndef UI_NASETTINGWIDGET_H
#define UI_NASETTINGWIDGET_H
...
public:
    ...
    void setupUi(QFrame *NASettingWidget)
    {
        if (NASettingWidget->objectName().isEmpty())
            NASettingWidget->setObjectName(QStringLiteral("NASettingWidget"));
        NASettingWidget->resize(882, 646);
        NASettingWidget->setFrameShape(QFrame::NoFrame);
        NASettingWidget->setFrameShadow(QFrame::Raised);
        verticalLayout = new QVBoxLayout(NASettingWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        frameHeader = new QFrame(NASettingWidget);
...
"}"));
        ...
        frameParameter = new QFrame(NASettingWidget);
...
"}"));
        ...
        frameKeyboard = new QFrame(NASettingWidget);
        ...
        retranslateUi(NASettingWidget);

        QMetaObject::connectSlotsByName(NASettingWidget);
    } // setupUi

    void retranslateUi(QFrame *NASettingWidget)
    {
        NASettingWidget->setWindowTitle(QApplication::translate("NASettingWidget", "Frame", 0));
        labelTitle->setText(QApplication::translate("NASettingWidget", "TextLabel", 0));
        toolButtonRestore->setText(QApplication::translate("NASettingWidget", "Restore", 0));
        toolButtonCancel->setText(QApplication::translate("NASettingWidget", "Cancel", 0));
        toolButtonOK->setText(QApplication::translate("NASettingWidget", "OK", 0));
    } // retranslateUi

};

namespace Ui {
    class NASettingWidget: public Ui_NASettingWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NASETTINGWIDGET_H
