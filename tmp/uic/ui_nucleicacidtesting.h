/********************************************************************************
** Form generated from reading UI file 'nucleicacidtesting.ui'
**
...
#ifndef UI_NUCLEICACIDTESTING_H
#define UI_NUCLEICACIDTESTING_H
...
public:
    ...
    void setupUi(QFrame *NucleicAcidTesting)
    {
        if (NucleicAcidTesting->objectName().isEmpty())
            NucleicAcidTesting->setObjectName(QStringLiteral("NucleicAcidTesting"));
        NucleicAcidTesting->resize(1076, 688);
        NucleicAcidTesting->setFrameShape(QFrame::NoFrame);
        NucleicAcidTesting->setFrameShadow(QFrame::Raised);
        horizontalLayout = new QHBoxLayout(NucleicAcidTesting);
        horizontalLayout->setSpacing(1);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        frameLeft = new QFrame(NucleicAcidTesting);
...
"}"));
        ...
        frameMain = new QFrame(NucleicAcidTesting);
...
"}"));
        ...
        frameBottom = new QFrame(NucleicAcidTesting);
        ...
        retranslateUi(NucleicAcidTesting);

        QMetaObject::connectSlotsByName(NucleicAcidTesting);
    } // setupUi

    void retranslateUi(QFrame *NucleicAcidTesting)
    {
        NucleicAcidTesting->setWindowTitle(QApplication::translate("NucleicAcidTesting", "Frame", 0));
        toolButtonBack->setText(QApplication::translate("NucleicAcidTesting", "Back", 0));
        toolButtonBlank->setText(QApplication::translate("NucleicAcidTesting", "Blank", 0));
        toolButtonMeasure->setText(QApplication::translate("NucleicAcidTesting", "Measure", 0));
        toolButtonSetting->setText(QApplication::translate("NucleicAcidTesting", "Setting", 0));
        toolButtonCapture->setText(QApplication::translate("NucleicAcidTesting", "Capture", 0));
        toolButtonClear->setText(QApplication::translate("NucleicAcidTesting", "Clear", 0));
    } // retranslateUi

};

namespace Ui {
    class NucleicAcidTesting: public Ui_NucleicAcidTesting {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NUCLEICACIDTESTING_H
