/********************************************************************************
** Form generated from reading UI file 'uvsettingwidget.ui'
**
...
#ifndef UI_UVSETTINGWIDGET_H
#define UI_UVSETTINGWIDGET_H
...
public:
    ...
    void setupUi(QFrame *UVSettingWidget)
    {
        if (UVSettingWidget->objectName().isEmpty())
            UVSettingWidget->setObjectName(QStringLiteral("UVSettingWidget"));
        UVSettingWidget->resize(882, 646);
        UVSettingWidget->setFrameShape(QFrame::NoFrame);
        UVSettingWidget->setFrameShadow(QFrame::Raised);
        verticalLayout = new QVBoxLayout(UVSettingWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        frameHeader = new QFrame(UVSettingWidget);
...
"}"));
        ...
        frameParameter = new QFrame(UVSettingWidget);
...
"}"));
        ...
        frameKeyboard = new QFrame(UVSettingWidget);
        ...
        retranslateUi(UVSettingWidget);

        QMetaObject::connectSlotsByName(UVSettingWidget);
    } // setupUi

    void retranslateUi(QFrame *UVSettingWidget)
    {
        UVSettingWidget->setWindowTitle(QApplication::translate("UVSettingWidget", "Frame", 0));
        labelTitle->setText(QApplication::translate("UVSettingWidget", "TextLabel", 0));
        toolButtonRestore->setText(QApplication::translate("UVSettingWidget", "Restore", 0));
        toolButtonCancel->setText(QApplication::translate("UVSettingWidget", "Cancel", 0));
        toolButtonOK->setText(QApplication::translate("UVSettingWidget", "OK", 0));
    } // retranslateUi

};

namespace Ui {
    class UVSettingWidget: public Ui_UVSettingWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UVSETTINGWIDGET_H
