/********************************************************************************
** Form generated from reading UI file 'ngtestingwidget.ui'
**
...
#ifndef UI_NGTESTINGWIDGET_H
#define UI_NGTESTINGWIDGET_H
...
public:
    ...
    void setupUi(QFrame *NGTestingWidget)
    {
        if (NGTestingWidget->objectName().isEmpty())
            NGTestingWidget->setObjectName(QStringLiteral("NGTestingWidget"));
        NGTestingWidget->resize(1076, 688);
        NGTestingWidget->setFrameShape(QFrame::NoFrame);
        NGTestingWidget->setFrameShadow(QFrame::Raised);
        horizontalLayout = new QHBoxLayout(NGTestingWidget);
        horizontalLayout->setSpacing(1);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        frameLeft = new QFrame(NGTestingWidget);
...
"}"));
        ...
        frameMain = new QFrame(NGTestingWidget);
...
"}"));
        ...
        frameBottom = new QFrame(NGTestingWidget);
        ...
        retranslateUi(NGTestingWidget);

        QMetaObject::connectSlotsByName(NGTestingWidget);
    } // setupUi

    void retranslateUi(QFrame *NGTestingWidget)
    {
        NGTestingWidget->setWindowTitle(QApplication::translate("NGTestingWidget", "Frame", 0));
        toolButtonBack->setText(QApplication::translate("NGTestingWidget", "Back", 0));
        toolButtonBlank->setText(QApplication::translate("NGTestingWidget", "Blank", 0));
        toolButtonMeasure->setText(QApplication::translate("NGTestingWidget", "Measure", 0));
        toolButtonSetting->setText(QApplication::translate("NGTestingWidget", "Setting", 0));
        toolButtonCapture->setText(QApplication::translate("NGTestingWidget", "Capture", 0));
        toolButtonClear->setText(QApplication::translate("NGTestingWidget", "Clear", 0));
    } // retranslateUi

};

namespace Ui {
    class NGTestingWidget: public Ui_NGTestingWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NGTESTINGWIDGET_H
