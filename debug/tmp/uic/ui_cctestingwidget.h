/********************************************************************************
** Form generated from reading UI file 'cctestingwidget.ui'
**
...
#ifndef UI_CCTESTINGWIDGET_H
#define UI_CCTESTINGWIDGET_H
...
public:
    ...
    void setupUi(QFrame *CCTestingWidget)
    {
        if (CCTestingWidget->objectName().isEmpty())
            CCTestingWidget->setObjectName(QStringLiteral("CCTestingWidget"));
        CCTestingWidget->resize(1076, 688);
        CCTestingWidget->setFrameShape(QFrame::NoFrame);
        CCTestingWidget->setFrameShadow(QFrame::Raised);
        horizontalLayout = new QHBoxLayout(CCTestingWidget);
        horizontalLayout->setSpacing(1);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        frameLeft = new QFrame(CCTestingWidget);
...
"}"));
        ...
        frameMain = new QFrame(CCTestingWidget);
...
"}"));
        ...
        frameBottom = new QFrame(CCTestingWidget);
        ...
        retranslateUi(CCTestingWidget);

        QMetaObject::connectSlotsByName(CCTestingWidget);
    } // setupUi

    void retranslateUi(QFrame *CCTestingWidget)
    {
        CCTestingWidget->setWindowTitle(QApplication::translate("CCTestingWidget", "Frame", 0));
        toolButtonBack->setText(QApplication::translate("CCTestingWidget", "Back", 0));
        toolButtonBlank->setText(QApplication::translate("CCTestingWidget", "Blank", 0));
        toolButtonMeasure->setText(QApplication::translate("CCTestingWidget", "Measure", 0));
        toolButtonSetting->setText(QApplication::translate("CCTestingWidget", "Setting", 0));
        toolButtonCapture->setText(QApplication::translate("CCTestingWidget", "Capture", 0));
        toolButtonClear->setText(QApplication::translate("CCTestingWidget", "Clear", 0));
    } // retranslateUi

};

namespace Ui {
    class CCTestingWidget: public Ui_CCTestingWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CCTESTINGWIDGET_H
