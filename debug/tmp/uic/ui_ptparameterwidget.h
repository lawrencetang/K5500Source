/********************************************************************************
** Form generated from reading UI file 'ptparameterwidget.ui'
**
...
#ifndef UI_PTPARAMETERWIDGET_H
#define UI_PTPARAMETERWIDGET_H
...
public:
    ...
    void setupUi(QFrame *PTParameterWidget)
    {
        if (PTParameterWidget->objectName().isEmpty())
            PTParameterWidget->setObjectName(QStringLiteral("PTParameterWidget"));
        PTParameterWidget->resize(511, 1050);
        PTParameterWidget->setStyleSheet(QString::fromUtf8("QFrame#PTParameterWidget{\n"
...
"	color: white;\n"
"}"));
        PTParameterWidget->setFrameShape(QFrame::StyledPanel);
        PTParameterWidget->setFrameShadow(QFrame::Raised);
        verticalLayout = new QVBoxLayout(PTParameterWidget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        formLayout = new QFormLayout();
        formLayout->setObjectName(QStringLiteral("formLayout"));
        formLayout->setLabelAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        formLayout->setVerticalSpacing(30);
        labelMwl = new QLabel(PTParameterWidget);
        ...
        spinBoxMwl = new QSpinBox(PTParameterWidget);
        ...
        labelChannelNumber = new QLabel(PTParameterWidget);
        ...
        spinBoxChannelNumber = new QSpinBox(PTParameterWidget);
        ...
        labelMeasureOptical = new QLabel(PTParameterWidget);
        ...
        comboBoxMeasureOptical = new QComboBox(PTParameterWidget);
        ...
        labelUnit = new QLabel(PTParameterWidget);
        ...
        comboBoxUnit = new QComboBox(PTParameterWidget);
        ...
        labelMethod = new QLabel(PTParameterWidget);
        ...
        comboBoxMethod = new QComboBox(PTParameterWidget);
        ...
        labelCoefficient = new QLabel(PTParameterWidget);
        ...
        doubleSpinBoxCoefficient = new QDoubleSpinBox(PTParameterWidget);
        ...
        labelMixingLevel = new QLabel(PTParameterWidget);
        ...
        comboBoxMixingLevel = new QComboBox(PTParameterWidget);
        ...
        labelMixingTime = new QLabel(PTParameterWidget);
        ...
        spinBoxMixingTime = new QSpinBox(PTParameterWidget);
        ...
        labelStaticTime = new QLabel(PTParameterWidget);
        ...
        spinBoxStaticTime = new QSpinBox(PTParameterWidget);
        ...
        labelBwl = new QLabel(PTParameterWidget);
        ...
        spinBoxBwl = new QSpinBox(PTParameterWidget);
        ...
        labelSampleName = new QLabel(PTParameterWidget);
        ...
        lineEditSampleName = new QLineEdit(PTParameterWidget);
        ...
        labelDetectionMothed = new QLabel(PTParameterWidget);
        ...
        comboBoxDetectionMothed = new QComboBox(PTParameterWidget);
        ...
        retranslateUi(PTParameterWidget);

        QMetaObject::connectSlotsByName(PTParameterWidget);
    } // setupUi

    void retranslateUi(QFrame *PTParameterWidget)
    {
        PTParameterWidget->setWindowTitle(QApplication::translate("PTParameterWidget", "Frame", 0));
        labelMwl->setText(QApplication::translate("PTParameterWidget", "Measure Wave Length:", 0));
        spinBoxMwl->setSuffix(QApplication::translate("PTParameterWidget", " nm", 0));
        labelChannelNumber->setText(QApplication::translate("PTParameterWidget", "Channel Number:", 0));
        labelMeasureOptical->setText(QApplication::translate("PTParameterWidget", "Measure Optical:", 0));
        labelUnit->setText(QApplication::translate("PTParameterWidget", "Used Unit:", 0));
        labelMethod->setText(QApplication::translate("PTParameterWidget", "Method:", 0));
        labelCoefficient->setText(QApplication::translate("PTParameterWidget", "Coefficient:", 0));
        labelMixingLevel->setText(QApplication::translate("PTParameterWidget", "Mixing Level:", 0));
        labelMixingTime->setText(QApplication::translate("PTParameterWidget", "Mixing Time:", 0));
        spinBoxMixingTime->setSuffix(QApplication::translate("PTParameterWidget", " s", 0));
        labelStaticTime->setText(QApplication::translate("PTParameterWidget", "Static Time:", 0));
        spinBoxStaticTime->setSuffix(QApplication::translate("PTParameterWidget", " s", 0));
        labelBwl->setText(QApplication::translate("PTParameterWidget", "Base Wave Length:", 0));
        spinBoxBwl->setSuffix(QApplication::translate("PTParameterWidget", " nm", 0));
        labelSampleName->setText(QApplication::translate("PTParameterWidget", "Sample Name:", 0));
        lineEditSampleName->setText(QApplication::translate("PTParameterWidget", "Sample", 0));
        labelDetectionMothed->setText(QApplication::translate("PTParameterWidget", "Detection Method:", 0));
    } // retranslateUi

};

namespace Ui {
    class PTParameterWidget: public Ui_PTParameterWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PTPARAMETERWIDGET_H
