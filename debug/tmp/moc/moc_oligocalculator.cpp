...
#include "../../../applications/oligocalculator/oligocalculator.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OligoCalculator_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(5, 43, 9) // "calculate"

    },
    "OligoCalculator\0backToMainPage\0\0back\0"
    "clear\0calculate"
};
...
void OligoCalculator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (OligoCalculator::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OligoCalculator::backToMainPage)) {
                *result = 0;
                return;
            }
        }
...
void *OligoCalculator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OligoCalculator.stringdata0))
...
// SIGNAL 0
void OligoCalculator::backToMainPage()
{
