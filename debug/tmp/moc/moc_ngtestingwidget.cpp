/****************************************************************************
** Meta object code from reading C++ file 'ngtestingwidget.h'
**
...
#include "../../../applications/nanogoldwindow/ngtestingwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/QVector>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ngtestingwidget.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_NGTestingWidget_t {
    QByteArrayData data[21];
    char stringdata0[252];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NGTestingWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NGTestingWidget_t qt_meta_stringdata_NGTestingWidget = {
    {
QT_MOC_LITERAL(0, 0, 15), // "NGTestingWidget"
...
QT_MOC_LITERAL(20, 232, 19) // "onMeasureBtnClicked"
    ...
    "NGTestingWidget\0backBtnClicked\0\0"
...
static const uint qt_meta_data_NGTestingWidget[] = {
...
void NGTestingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NGTestingWidget *_t = static_cast<NGTestingWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (NGTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NGTestingWidget::backBtnClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (NGTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NGTestingWidget::toSettingPage)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (NGTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NGTestingWidget::toStartBlank)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (NGTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NGTestingWidget::toStartMeasure)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject NGTestingWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_NGTestingWidget.data,
      qt_meta_data_NGTestingWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *NGTestingWidget::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NGTestingWidget::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_NGTestingWidget.stringdata0))
        return static_cast<void*>(const_cast< NGTestingWidget*>(this));
    return QFrame::qt_metacast(_clname);
}

int NGTestingWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void NGTestingWidget::backBtnClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void NGTestingWidget::toSettingPage()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void NGTestingWidget::toStartBlank()
{
    QMetaObject::activate(this, &staticMetaObject, 2, Q_NULLPTR);
}

// SIGNAL 3
void NGTestingWidget::toStartMeasure()
{
