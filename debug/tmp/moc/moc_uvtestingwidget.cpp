/****************************************************************************
** Meta object code from reading C++ file 'uvtestingwidget.h'
**
...
#include "../../../applications/uvviswindow/uvtestingwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/QVector>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'uvtestingwidget.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_UVTestingWidget_t {
    QByteArrayData data[21];
    char stringdata0[252];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UVTestingWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UVTestingWidget_t qt_meta_stringdata_UVTestingWidget = {
    {
QT_MOC_LITERAL(0, 0, 15), // "UVTestingWidget"
...
QT_MOC_LITERAL(20, 232, 19) // "onMeasureBtnClicked"
    ...
    "UVTestingWidget\0backBtnClicked\0\0"
...
static const uint qt_meta_data_UVTestingWidget[] = {
...
void UVTestingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UVTestingWidget *_t = static_cast<UVTestingWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (UVTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UVTestingWidget::backBtnClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (UVTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UVTestingWidget::toSettingPage)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (UVTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UVTestingWidget::toStartBlank)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (UVTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UVTestingWidget::toStartMeasure)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject UVTestingWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_UVTestingWidget.data,
      qt_meta_data_UVTestingWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *UVTestingWidget::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *UVTestingWidget::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_UVTestingWidget.stringdata0))
        return static_cast<void*>(const_cast< UVTestingWidget*>(this));
    return QFrame::qt_metacast(_clname);
}

int UVTestingWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void UVTestingWidget::backBtnClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void UVTestingWidget::toSettingPage()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void UVTestingWidget::toStartBlank()
{
    QMetaObject::activate(this, &staticMetaObject, 2, Q_NULLPTR);
}

// SIGNAL 3
void UVTestingWidget::toStartMeasure()
{
