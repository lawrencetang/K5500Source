#############################################################################
# Makefile for building: UltramicroSpectrophotometer
# Generated by qmake (3.0) (Qt 5.4.2)
# Project:  UltramicroSpectrophotometer.pro
# Template: app
# Command: C:\Qt\Qt5.4.2\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile UltramicroSpectrophotometer.pro
#############################################################################
...
Makefile: UltramicroSpectrophotometer.pro C:/Qt/Qt5.4.2/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.4.2/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
		...
		oledevices/oledevices.pri \
		oledrivers/oledrivers.pri \
		C:/Qwt-6.1.2/features/qwtconfig.pri \
		C:/Qwt-6.1.2/features/qwtfunctions.pri \
		C:/Qwt-6.1.2/features/qwt.prf \
		oleplugins/oleplugins.pri \
		oleprotocols/oleprotocols.pri \
		applications/applications.pri \
