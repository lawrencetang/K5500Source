/********************************************************************************
** Form generated from reading UI file 'ptsettingwidget.ui'
**
...
#ifndef UI_PTSETTINGWIDGET_H
#define UI_PTSETTINGWIDGET_H
...
public:
    ...
    void setupUi(QFrame *PTSettingWidget)
    {
        if (PTSettingWidget->objectName().isEmpty())
            PTSettingWidget->setObjectName(QStringLiteral("PTSettingWidget"));
        PTSettingWidget->resize(882, 646);
        PTSettingWidget->setFrameShape(QFrame::NoFrame);
        PTSettingWidget->setFrameShadow(QFrame::Raised);
        verticalLayout = new QVBoxLayout(PTSettingWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        frameHeader = new QFrame(PTSettingWidget);
...
"}"));
        ...
        frameParameter = new QFrame(PTSettingWidget);
...
"}"));
        ...
        frameKeyboard = new QFrame(PTSettingWidget);
        ...
        retranslateUi(PTSettingWidget);

        QMetaObject::connectSlotsByName(PTSettingWidget);
    } // setupUi

    void retranslateUi(QFrame *PTSettingWidget)
    {
        PTSettingWidget->setWindowTitle(QApplication::translate("PTSettingWidget", "Frame", 0));
        labelTitle->setText(QApplication::translate("PTSettingWidget", "TextLabel", 0));
        toolButtonRestore->setText(QApplication::translate("PTSettingWidget", "Restore", 0));
        toolButtonCancel->setText(QApplication::translate("PTSettingWidget", "Cancel", 0));
        toolButtonOK->setText(QApplication::translate("PTSettingWidget", "OK", 0));
    } // retranslateUi

};

namespace Ui {
    class PTSettingWidget: public Ui_PTSettingWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PTSETTINGWIDGET_H
