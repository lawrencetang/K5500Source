...
public:
    ...
    void setupUi(QFrame *SettingWidget)
    {
        if (SettingWidget->objectName().isEmpty())
            SettingWidget->setObjectName(QStringLiteral("SettingWidget"));
        SettingWidget->resize(882, 646);
        SettingWidget->setStyleSheet(QLatin1String("QFrame#NucleicAcidSetting{\n"
"	background-color: white;\n"
"}"));
        SettingWidget->setFrameShape(QFrame::NoFrame);
        SettingWidget->setFrameShadow(QFrame::Raised);
        verticalLayout = new QVBoxLayout(SettingWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        frameHeader = new QFrame(SettingWidget);
...
"}"));
        ...
        frameParameter = new QFrame(SettingWidget);
...
"}"));
        ...
        frameKeyboard = new QFrame(SettingWidget);
    ...
    void retranslateUi(QFrame *SettingWidget)
    {
        SettingWidget->setWindowTitle(QApplication::translate("SettingWidget", "Frame", 0));
        labelTitle->setText(QApplication::translate("SettingWidget", "TextLabel", 0));
        toolButtonRestore->setText(QApplication::translate("SettingWidget", "Restore", 0));
        toolButtonCancel->setText(QApplication::translate("SettingWidget", "Cancel", 0));
        toolButtonOK->setText(QApplication::translate("SettingWidget", "OK", 0));
    } // retranslateUi
