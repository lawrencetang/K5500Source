/****************************************************************************
** Meta object code from reading C++ file 'pttestingwidget.h'
**
...
#include "../../../applications/proteinwindow/pttestingwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/QVector>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pttestingwidget.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_PTTestingWidget_t {
    QByteArrayData data[21];
    char stringdata0[252];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PTTestingWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PTTestingWidget_t qt_meta_stringdata_PTTestingWidget = {
    {
QT_MOC_LITERAL(0, 0, 15), // "PTTestingWidget"
...
QT_MOC_LITERAL(20, 232, 19) // "onMeasureBtnClicked"
    ...
    "PTTestingWidget\0backBtnClicked\0\0"
...
static const uint qt_meta_data_PTTestingWidget[] = {
...
void PTTestingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PTTestingWidget *_t = static_cast<PTTestingWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (PTTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PTTestingWidget::backBtnClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PTTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PTTestingWidget::toSettingPage)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (PTTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PTTestingWidget::toStartBlank)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (PTTestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PTTestingWidget::toStartMeasure)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject PTTestingWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_PTTestingWidget.data,
      qt_meta_data_PTTestingWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *PTTestingWidget::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *PTTestingWidget::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_PTTestingWidget.stringdata0))
        return static_cast<void*>(const_cast< PTTestingWidget*>(this));
    return QFrame::qt_metacast(_clname);
}

int PTTestingWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void PTTestingWidget::backBtnClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void PTTestingWidget::toSettingPage()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void PTTestingWidget::toStartBlank()
{
    QMetaObject::activate(this, &staticMetaObject, 2, Q_NULLPTR);
}

// SIGNAL 3
void PTTestingWidget::toStartMeasure()
{
