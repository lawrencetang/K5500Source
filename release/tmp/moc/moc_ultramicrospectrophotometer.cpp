...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UltramicroSpectrophotometer_t, stringdata0) + ofs \
...
void *UltramicroSpectrophotometer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UltramicroSpectrophotometer.stringdata0))
