/****************************************************************************
** Meta object code from reading C++ file 'natestingwidget.h'
**
...
#include "../../../applications/nucleicacidwindow/natestingwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/QVector>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'natestingwidget.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_NATestingWidget_t {
    QByteArrayData data[21];
    char stringdata0[252];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NATestingWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NATestingWidget_t qt_meta_stringdata_NATestingWidget = {
    {
QT_MOC_LITERAL(0, 0, 15), // "NATestingWidget"
...
QT_MOC_LITERAL(20, 232, 19) // "onMeasureBtnClicked"
    ...
    "NATestingWidget\0backBtnClicked\0\0"
...
static const uint qt_meta_data_NATestingWidget[] = {
...
void NATestingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NATestingWidget *_t = static_cast<NATestingWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (NATestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NATestingWidget::backBtnClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (NATestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NATestingWidget::toSettingPage)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (NATestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NATestingWidget::toStartBlank)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (NATestingWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NATestingWidget::toStartMeasure)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject NATestingWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_NATestingWidget.data,
      qt_meta_data_NATestingWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *NATestingWidget::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NATestingWidget::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_NATestingWidget.stringdata0))
        return static_cast<void*>(const_cast< NATestingWidget*>(this));
    return QFrame::qt_metacast(_clname);
}

int NATestingWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void NATestingWidget::backBtnClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void NATestingWidget::toSettingPage()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void NATestingWidget::toStartBlank()
{
    QMetaObject::activate(this, &staticMetaObject, 2, Q_NULLPTR);
}

// SIGNAL 3
void NATestingWidget::toStartMeasure()
{
